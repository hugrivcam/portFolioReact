...
export const cardContent = [
  {
    ...
    description:
      "Mi <span style='color:orange'>primera aplicación profesional</span> seria desarrollada para una tienda de complementos. Incluye gestión completa de <span style='color:cyan'> inventario, ventas, tickets, devoluciones, proveedores, cambio de temporadas, contabilidad </span>básica ... desarrollada en Borland <span style='color:orange'>C++</span> para windows en 2002 y en producción, base de datos <span style='color:orange'>paradox</span> , al menos, durante más de 15 años",
  ...
  },
  {
    ...
    description:
      "Aplicación desarrollada especificamente para una academia de oposiciones. Permite gestionar los <span style='color:cyan'> test de evaluación. Crear, editar, imprimir, exportar, importar</span>, año desarrollo 2007 Borland <span style='color:orange'>C++</span>, base de datos <span style='color:orange'>sql server</span>.",
  ...
  },
  {
    ...
    description:
      "<span style='color:cyan'> Analisis y Desarrollo integro del sistema de gestión para las oficinas de recaudación ejecutiva de la XUNTA</span>, para la gestion de miles de expedientes al año, la aplicación permite (aun en uso hasta que se extingan dichas oficinas) la comunicación con el sistema central de recaudación de la xunta y otras entidades para la consecución de la gestión de los expedientes." +
      " Implementados: <span style='color:cyan'> Control automatizado expedientes, extensa selección de criterios, control de prescripciones, cálculo de intereses al dia, control automatizado de solicitudes de información " +
  ...
  },
  {
    ...
    description:
      "Actualmente estoy formación continua en <span style='color:orange'>Angular</span> principalmente, incluyendo, <span style='color:orange'>JS, CSS, TS</span>, además he añadido varios ejemplos, para practicar en el desarrollo en Angular y JS. Tambien he creado una pequeña aplicación para inciarme en el lado <span style='color:orange'> Back-end API REST con Java Spring boot</span> Desplegando dicho servicio a través de un servidor en la nube de Amazon. Como complemento tambien estoy dedicando tiempo a programación a .net <span style='color:orange'>C#</span>, desarrollo en 4 capas. Este mismo portFolio lo he creado en <span style='color:orange'>React</span> para ampliar mis conocimientos.",
